...
const StudyDestination = () => {
  return (
    ...
    Explore the world's most popular <span className='text-primary'>study destinations</span>
    </h1>
    ...
    >
        {/* Swiper Slides */}
        <SwiperSlide>
            <img className="w-full" src="/images/destination/photo01.png" alt="Subject 1" />
            <p className='text-center'>London</p>
        </SwiperSlide>
        <SwiperSlide>
            <img className="w-full" src="/images/destination/photo02.png" alt="Subject 2" />
            <p className='text-center'>Australia</p>
        </SwiperSlide>
        <SwiperSlide>
            <img className="w-full" src="/images/destination/photo03.png" alt="Subject 3" />
            <p className='text-center'>Canada</p>
        </SwiperSlide>
        <SwiperSlide>
            <img className="w-full" src="/images/destination/photo04.png" alt="Subject 4" />
